 ...
 *
 * @class OPSTestInstallTool
 *
 * @ingroup tools
 *
 * @brief Non-interactive OPS install for the Playwright test harness.
 *
 ...
 * The OJS_ prefix is the shared harness convention across OJS/OMP/OPS —
 * lib/pkp/tools/resetTest.php reads the same names:
...
class OPSTestInstallTool extends \PKP\cliTool\InstallTool
{
...
$tool = new OPSTestInstallTool($argv ?? []);
$tool->execute();
